...
const partyImages = {
  ...
  conservative:
    "http://www.thenopebook.com/wp-content/uploads/2017/08/Conservative_logo_2006.svg_-1020x685.png",
  "liberal democrat":
    "https://pbs.twimg.com/profile_images/2842004882/1fbd17636444a3a99ac928bf96df0b30_400x400.jpeg",
  "green party":
    "https://www.greenparty.org.uk/assets/logos/visual-identity/Stack/Green%20on%20White/GPEW-stack-online-gw.png"
};
...
const ProfileImages = props => {
  ...
  return (
    <div>
      {props.twitterHandle ? (
        <img
          src={`https://avatars.io/twitter/${props.twitterHandle.slice(
            1
          )}/medium`}
          style={{ width: 128, height: 128, marginLeft: 20 }}
        />
      ) : (
        ""
      )}
